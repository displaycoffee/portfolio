...
export const Route = createLazyFileRoute('/cheat-codes/(children)/wish-you-were-here/')({
	...
	return (
		<Contents {...cheatCodesOptionsBody}>
			...
			<CheatCodesSection header={'Usage'}>
				...
				<p>
					<LinkExternal href={'//github.com/displaycoffee/cheat-codes/tree/production/wish-you-were-here'}>
						View @ displaycoffee
					</LinkExternal>
				</p>
