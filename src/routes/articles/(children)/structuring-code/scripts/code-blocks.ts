...
export const codeBlocks = [
	...
	`<div class="fancy-pants-div">Look at dem fancy pants.</div>`,
	`<div style="background: green; font-family: Arial, sans-serif; color: #ffffff;">Here's a green div.</div>
	...
	`.green-div, .purple-div {font-family:Arial, sans-serif;color:#ffffff;}
	.green-div
	{
		background: green; }
	.purple-div {
	...
	`<div class="polka-dot-trex">I got some text for you right here.<p>Okay, but be nice!</p><img src="//placecats.com/millie/300/150" alt="It's a cat" width="300" height="150" /><div class="glow-in-the-dark-triceratops">Maybe we'll put some new text here.</div>
	...
	`<div class="polka-dot-trex">
		...
		<img src="//placecats.com/millie/300/150" alt="It's a cat" width="300" height="150" />
