...
import { CodeBlock, CodeInline, LinkExternal, List, ListItem, Output } from '../../../../components/blocks/Blocks';

export const Route = createLazyFileRoute('/articles/(children)/styling-text/')({
