					...
					<div className="dc-friends-not-food-more-info dc-friends-not-food-absolute">
						<main className="dc-friends-not-food-vertical">
							<div className="dc-friends-not-food-block">
								<p>
									Quagga mussel cat shark is batfish frogfish. . Peppered moray clownfish hawkfish at seahorse hammerhead a funny
									snake eel. Wobbegong shark blue whale gold damsel faucet snail, in snake eel sea coral grouper. The crackin crazy
									Neon goby nurse shark moon. Quagga musse.
								</p>
								<p>
							...
							<div className="dc-friends-not-food-block">
								<p>
									Pigtoe sea coral king crab heelsplitter, in painted comber Banded eel bicolor blenny. Bursa trigger funny
									filefish, a Snaggletooth shark lobster in. Spotted sweetlips loving in catshark pebblesnail at seabass with faucet
									snail. Yellow pseudochromis weasel shark shadow, darkness in deap ocean an, Motionless Wabash pigtoe Full moon.
									Fishies asian cla
								</p>
								<p>
									Painted comber, king crab a elktoe a, grey whale seahorse. The crackin crazy Neon goby nurse shark moon. Hippo
									tang gold damsel peaclam.
								</p>
							</div>
						</main>
					</div>
						...
						<main className="dc-friends-not-food-profile">
							<div className="dc-friends-not-food-row">
								...
								<div className="dc-friends-not-food-quote dc-friends-not-food-column">
									<div className="dc-friends-not-food-block">
										<p>
											I am a nice shark, not a mindless eating machine. If I am to change this image, I must first change
